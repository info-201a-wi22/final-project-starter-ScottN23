...
intro_page <- tabPanel("Introduction",
         ...
         fluidRow(
           column(8, align = "center", offset = 2,
                  p("Currently, a pandemic, the Coronavirus or COVID-19, 
                           has played a role in impacting the lives and wellbeing of families from all around the world. COVID-19 has definitely taken a toll on the economy, 
